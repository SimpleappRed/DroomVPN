...
extension PacketTunnelProvider: OpenVPNAdapterDelegate {
    ...
    func _updateConnectionStatus(_ openVPNAdapter: OpenVPNAdapter) {
        var toSave = ""
           ...
           UserDefaults.init(suiteName: "com.droomvpn.app.VPNExtensions")?.setValue(toSave, forKey: "connectionUpdate")
    }
    ...
    func _updateEvent(_ event: OpenVPNAdapterEvent) {
        ...
        UserDefaults.init(suiteName: "com.droomvpn.app.VPNExtensions")?.setValue(toSave, forKey: "vpnStatusGroup")
    }

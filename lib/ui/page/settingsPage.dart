...
import '../../core/resources/DroomVPNIcon.dart';
...
class PengaturanPage extends StatelessWidget {
                      ...
                      if (snapshot.hasData) {
                        if (snapshot.data!.version.sdkInt > 24) {
                          return ListTile(
                            ...
                            leading: Icon(DroomVPNIcon.settings, color: Colors.black),
  ...
  void _tosClick() {
    launch("https://vpn.quoapp.xyz/terms.html/");
  }

  void _privacyPolicyClick(context) {
    launch("https://vpn.quoapp.xyz/privacy.html/");
  }
